...
python -m scripts.report && uvx pandoc reports/d6/report.md -o reports/d6/report.html

ELAPSED=$(( SECONDS - START_TIME ))
echo "speedrun_d6 total time: $(( ELAPSED / 3600 ))h $(( (ELAPSED % 3600) / 60 ))m $(( ELAPSED % 60 ))s"
echo "to view your report, copy reports/d6/ to your local machine, e.g. using scp"
