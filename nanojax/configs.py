...
d20 = GPTConfig(n_layer=20, n_embed=1280, n_head=5, n_kv_head=5, vocab_size=65536, sequence_len=4096)
...
d12 = GPTConfig(n_layer=12, n_embed=768, n_head=3, n_kv_head=3, vocab_size=50304, sequence_len=1024) # ~162M
