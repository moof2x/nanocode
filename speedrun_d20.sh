...
python -m nanojax.dataset -d fineweb-edu -n 130
python -m nanojax.dataset -d the-stack-v2-dedup -n 30
...
python -m scripts.report && uvx pandoc reports/d20/report.md -o reports/d20/report.html

ELAPSED=$(( SECONDS - START_TIME ))
echo "speedrun_d20 total time: $(( ELAPSED / 3600 ))h $(( (ELAPSED % 3600) / 60 ))m $(( ELAPSED % 60 ))s"
echo "to view your report, copy reports/d20/ to your local machine, e.g. using scp"
